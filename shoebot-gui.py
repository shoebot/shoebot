...
class View(gtk.Window):
    def __init__(self, buffer=None):
        menu_items = [
            ...
            ( "/Run/_Run script", None, self.run_script, False, None ),
            ( "/Run/_Run script with socketserver", None, self.run_script, True, None ),
            ]
    ...
    def run_script(self, use_socketserver, widget):
