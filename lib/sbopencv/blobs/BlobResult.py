...
class CBlobResult(_object):
    ...
    def __add__(*args):
        return _BlobResult.CBlobResult___add__(*args)

    def filter_blobs(*args):
        return _BlobResult.CBlobResult_filter_blobs(*args)

    def AddBlob(*args):
        return _BlobResult.CBlobResult_AddBlob(*args)

    def GetSTLResult(*args):
        return _BlobResult.CBlobResult_GetSTLResult(*args)

    def GetNumber(*args):
        return _BlobResult.CBlobResult_GetNumber(*args)

    def Filter(*args):
        return _BlobResult.CBlobResult_Filter(*args)

    def GetNthBlob(*args):
        return _BlobResult.CBlobResult_GetNthBlob(*args)

    def GetBlob(*args):
        return _BlobResult.CBlobResult_GetBlob(*args)

    def ClearBlobs(*args):
        return _BlobResult.CBlobResult_ClearBlobs(*args)

    def PrintBlobs(*args):
        return _BlobResult.CBlobResult_PrintBlobs(*args)

    def GetNumBlobs(*args):
        return _BlobResult.CBlobResult_GetNumBlobs(*args)
