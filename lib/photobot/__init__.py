...
class Canvas:
    ...
    A canvas is an empty Photoshop document, where layers can be placed and
    manipulated.
    """
    ...
    def __init__(self, w, h):
        ...
        Creates the working area on which to blend layers. The canvas background
        is transparent, but a background color could be set using the fill()
        function.
        """
    ...
    def fill(self, rgb, x=0, y=0, w=None, h=None, name=""):
        ...
        Creates a new layer filled with the given rgb color. For example,
        fill((255,0,0)) creates a red fill. The layers fills the entire canvas
        by default.
        """
    ...
    def gradient(self, style=LINEAR, w=1.0, h=1.0, name=""):
        ...
        if style == RADIAL:
            ...
            for i in range(int(r)):
                k = 255 - 255.0 * i / r
                draw.ellipse(
                    (w / 2 - r + i, h / 2 - r + i, w / 2 + r - i, h / 2 + r - i),
                    fill=int(k),
                )
    ...
    def merge(self, layers):
        ...
        Merges the given layers with the indices in the list on the bottom layer
        in the list. The other layers are discarded.
        """
    ...
    def flatten(self, layers=[]):
        ...
        Merges all layers to the canvas, using the blend mode and opacity
        defined for each layer. Once flattened, the stack of layers is emptied
        except for the transparent background (bottom layer).
        """
    ...
    def export(self, filename):
        ...
        Flattens the canvas. PNG retains the alpha channel information. Other
        possibilities are JPEG and GIF.
        """
    ...
    def draw(self, x, y):
        ...
        Exports to a temporary PNG file. Draws the PNG in NodeBox using the
        image() command. Removes the temporary file.
        """
    ...
    def preferences(interpolation=BILINEAR):
        ...
        Currently, only defines the image interpolation, which can be set to
...
class Layer:
    ...
    A canvas layer stores an image at a given position on the canvas, and all
    the Photoshop transformations possible for this layer: duplicate(),
    desature(), overlay(), rotate(), and so on.
    """
    ...
    def index(self):
        ...
        Searches the position of this layer in the canvas' layers list, return
        None when not found.
        """
    ...
    def copy(self):
        ...
        This is different from the duplicate() method, which duplicates the
        layer as a new layer on the canvas. The copy() method returns a copy of
        the layer that can be added to a different canvas.
        """
    ...
    def brightness(self, value=1.0):
        ...
        The given value is a percentage to increase or decrease the image
        brightness, for example 0.8 means brightness at 80%.
        """
    ...
    def contrast(self, value=1.0):
        ...
        The given value is a percentage to increase or decrease the image
        contrast, for example 1.2 means contrast at 120%.
        """
    ...
    def desaturate(self):
        ...
        Instantly removes all color information from the layer, while maintaing
        its alpha channel.
        """
    ...
    def translate(self, x, y):
        ...
        The x and y parameters define where to position the top left corner of
        the layer, measured from the top left of the canvas.
        """
    ...
    def scale(self, w=1.0, h=1.0):
        ...
        When width w or height h is a floating-point number, scales percentual,
    ...
    def distort(self, x1=0, y1=0, x2=0, y2=0, x3=0, y3=0, x4=0, y4=0):
        ...
        Distorts the layer by translating the four corners of its bounding box
        to the given coordinates: upper left (x1,y1), upper right(x2,y2), lower
        right (x3,y3) and lower left (x4,y4).
        """
    ...
    def sharpen(self, value=1.0):
        ...
        The given value is a percentage to increase or decrease the image
        sharpness, for example 0.8 means sharpness at 80%.
        """
    ...
    def levels(self):
        ...
        Returns a 4-tuple of lists, r, g, b, and a. Each list has 255 items, a
        count for each pixel value.
        """
...
class Blend:
    ...
    def overlay(self, img1, img2):
        ...
        Overlays image img2 on image img1. The overlay pixel combines multiply
        and screen: it multiplies dark pixels values and screen light values.
    ...
    def hue(self, img1, img2):
        ...
        Hues image img1 with image img2. The hue filter replaces the hues of
        pixels in img1 with the hues of pixels in img2. Returns a composite
    ...
    def color(self, img1, img2):
        ...
        Colorize image img1 with image img2. The color filter replaces the hue
        and saturation of pixels in img1 with the hue and saturation of pixels
        in img2. Returns a composite image with the alpha channel retained.
        """
...
class Pixels:
    ...
    def convolute(self, kernel, scale=None, offset=0):
        ...
        The kernel argument is a list with either 9 or 25 elements, the weight
        for each surrounding pixels to convolute.
        """
