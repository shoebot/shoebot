...
class events:
    ...
    def update(self):
        ...
        Hovering a node fires the callback function events.hover(). Clicking a
        node fires the callback function events.click().
        """
        if self.mousedown:
    ...
    def drag(self, node):
        ...
        if s.stroke:
            ...
            self._ctx.stroke(s.stroke.r, s.stroke.g, s.stroke.g, 0.75)
