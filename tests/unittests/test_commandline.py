...
class TestCommandLine(unittest.TestCase):
    """
    See if the commands can start successfully, by starting them with an option
    that does nothing: --version.

    When dependencies are not installed these commands will not return an error.
    """
    ...
    @parameterized.expand(
        [("sbot", "this_will_fail()"), ("sbot", "-dt", "this_will_fail()")],
    )
